...
spark = (
    SparkSession.builder.appName("Query5b_Optimized")
...
PATH_B = "../data/data_optimization_results/version_b"
...
(
    matches
    .repartition("map_id") 
    .sortWithinPartitions("playlist_id", "match_id")
...
print(f"Wrote Parquet files to {PATH_B}")
