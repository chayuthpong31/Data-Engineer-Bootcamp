...
spark = (
    SparkSession.builder.appName("Query5a_Optimized")
...
PATH_A = "../data/data_optimization_results/version_5a"
...
(
    ...
    .sortWithinPartitions("map_id", "match_id")
...
print(f"Wrote Parquet files to {PATH_A}")
